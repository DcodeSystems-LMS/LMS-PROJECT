-- Fix Course Materials Table Schema Cache Issue
-- Run this in your Supabase SQL editor

-- First, let's refresh the schema cache by recreating the table structure
-- Drop and recreate the course_materials table to fix schema cache issues

DROP TABLE IF EXISTS public.course_materials CASCADE;

-- Recreate course_materials table
...
SELECT 'Course materials table created successfully' as status;
SELECT COUNT(*) as material_count FROM public.course_materials;
