  ...
  return (
    <div className="min-h-screen bg-theme-bg-secondary overflow-x-hidden">
      ...
      <div className={`lg:flex lg:flex-col lg:flex-1 transition-all duration-300 overflow-x-hidden ${
        ...
        <div className="fixed top-0 left-0 right-0 z-40 flex h-16 flex-shrink-0 items-center gap-x-4 border-b border-theme-border bg-theme-card-bg px-4 sm:gap-x-6 sm:px-6 lg:pl-24 lg:pr-8">
          {/* Mobile menu button */}
          <button
            type="button"
