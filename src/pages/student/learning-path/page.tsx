    ...
    <div className="min-h-screen bg-theme-bg-secondary">
      <div className="flex flex-col lg:flex-row h-[calc(100vh-4rem)]">
        ...
        <button
          ...
          className="lg:hidden fixed top-20 left-4 z-30 p-2 bg-theme-card-bg border border-theme-border rounded-lg shadow-md"
        >
          <i className="ri-menu-line text-xl text-theme-text-primary"></i>
        </button>
