...
const navigation = [
  ...
  { name: 'Analytics', href: '/admin/analytics', icon: 'ri-bar-chart-line' },
  { name: 'Integrations', href: '/admin/integrations', icon: 'ri-plug-line' },
...
export default function AdminLayout() {
  ...
  const { isCollapsed, toggleSidebar } = useSidebar('admin-sidebar-collapsed');
