  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Monitor transactions, payouts, and financial analytics</p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900">$85,320</p>
            </div>
          </div>
        </div>
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-center">
            <div className="w-12 h-12 flex items-center justify-center bg-purple-100 rounded-lg mr-4">
              <i className="ri-refund-line text-2xl text-purple-600"></i>
            </div>
            <div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex flex-col md:flex-row gap-4 justify-between items-start md:items-center mb-6">
              <h2 className="text-lg font-semibold text-gray-900">Student Payments</h2>
              <div className="flex flex-col sm:flex-row gap-2 flex-1 md:max-w-lg">
        ...
        <div>
              ...
              {mentorPayouts.map((payout) => (
                <div key={payout.id} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      <div className="font-medium text-gray-900">{payout.mentor}</div>
                  ...
                  <div className="flex justify-between items-center">
                    <div className="text-sm text-gray-500">{payout.students} students</div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mt-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <i className="ri-bank-card-line text-lg text-blue-600 mr-3"></i>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <i className="ri-paypal-line text-lg text-blue-600 mr-3"></i>
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center">
                  <i className="ri-bank-line text-lg text-green-600 mr-3"></i>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600 mb-1">$425,780</div>
            <div className="text-sm text-gray-600">Total Revenue (YTD)</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-blue-600 mb-1">$68,340</div>
            <div className="text-sm text-gray-600">Mentor Payouts</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-600 mb-1">$357,440</div>
            <div className="text-sm text-gray-600">Net Revenue</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600 mb-1">15.7%</div>
