-- Add Assessment Attempts Tracking
-- This script creates tables to track student attempts and instructor feedback
...
CREATE TABLE IF NOT EXISTS public.assessment_attempts (
  ...
  UNIQUE(student_id, assessment_id, started_at) -- Allow multiple attempts
);

-- Add instructor feedback column to assessments table
...
-- Instructors can view attempts for their assessments
...
-- Function to start an assessment attempt
...
CREATE OR REPLACE FUNCTION get_assessment_stats(p_assessment_id UUID)
RETURNS TABLE (
