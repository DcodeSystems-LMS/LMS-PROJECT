...
async function loadSelectedLanguage(skipSetDefaultSourceCodeName = false) {
    ...
    if (!skipSetDefaultSourceCodeName) {
        ...
        // Set basic template for the selected language
        const languageName = $selectLanguage.find(":selected").text();
        sourceEditor.setValue(getBasicTemplateForLanguage(languageName));
    }
}
...
function getBasicTemplateForLanguage(languageName) {
    const templates = {
        "C": "#include <stdio.h>\n\nint main() {\n    // Your code here\n    return 0;\n}",
        "C++": "#include <iostream>\nusing namespace std;\n\nint main() {\n    // Your code here\n    return 0;\n}",
        ...
        "Visual Basic": "Module Module1\n    Sub Main()\n        ' Your code here\n    End Sub\nEnd Module"
    };
    
    // Try to match language name
    for (let key in templates) {
        if (languageName.toLowerCase().includes(key.toLowerCase())) {
